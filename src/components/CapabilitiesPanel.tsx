...
const CAPABILITIES: CapabilityConfig[] = [
  ...
  { key: 'resistanceControl', label: 'Resistance Control', icon: IconAdjustments },
...
export function CapabilitiesPanel({ statuses }: CapabilitiesPanelProps) {
  return (
    <SimpleGrid className="capability-grid capability-grid--compact" cols={{ base: 2, sm: 3 }} spacing="sm">
        ...
        return (
          <div className={`capability-item capability-item--${tone}`} key={capability.key}>
            <div className="capability-main">
              <ThemeIcon color={getIconColor(status)} radius="xl" size={40} variant="light">
