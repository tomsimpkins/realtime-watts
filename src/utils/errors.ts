...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  NetworkError: 'Could not connect to the trainer. Make sure it is awake and nearby.',
  NotAllowedError: 'Bluetooth permission was denied. Allow access and try again.',
